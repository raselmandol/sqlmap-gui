...
class TerminalWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.output.setStyleSheet("background: #f0f1ec; color: #000000; font-family: Consolas, monospace;")
        self.output.append("See Help tab for guidance on available options.")
